...
local strings = {
    ...
    TGU_OPTIONS_WERE_NUMBER_ONE =        "Play a sound when you hit #1",
    TGU_OPTIONS_WERE_NUMBER_ONE_TOOLTIP ="Play a sound when you hit #1 position in the list for your selected Ultimate",
