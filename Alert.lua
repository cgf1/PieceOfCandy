...
function Alert.Initialize(_saved)
    ...
    ZO_CreateStringId("SI_BINDING_NAME_POC_NEEDHELP_KEY", "Notify raid that you need help")
    ZO_CreateStringId("SI_BINDING_NAME_POC_TEXTUREHACK_KEY", "Hack your way out of a texture bug")
    RegClear(clearernow)
