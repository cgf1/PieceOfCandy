...
local mianada = setmetatable({}, Col)
...
watch('MIAing', name, apid, player.Ults[apid], group_members[name].Ults[apid])
		    ...
		    if tbl[name] and (MIAing or player.UltMain == apid) then
			ults[#ults + 1] = name
		    end
		end
